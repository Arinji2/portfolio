    ...
    <Suspense fallback={<></>}>
      <DesignerModal>
        <div className="h-fit flex w-[95%]  flex-col items-center justify-start gap-10 py-10">
          ...
          <div className="w-full h-fit px-3 xl:min-h-[370px] min-h-[250px]   overflow-y-hidden flex flex-row items-stretch no-scrollbar justify-start overflow-x-auto gap-5 shrink-0">
